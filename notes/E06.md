...
All the big companies use multiple languages for different microservice  --> depends on the requorement , which tech stack suits them best .
...
Our browsers block us to call APIs from one origin to another orgin (youtube cors explained by akshay saini)
